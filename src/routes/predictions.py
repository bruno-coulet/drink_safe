...
def executer_prediction(
    ...
    if payload.ph < 6.5 or payload.ph > 8.5:
        ...
        raison_rejet = "Turbidité supérieure à la recommandation maximale de l'OMS (5.0 NTU)."
    elif payload.Chloramines > 4.0:
        raison_rejet = "Concentration en chloramines supérieure au seuil de sécurité (4.0 mg/L)."
    elif payload.Trihalomethanes > 80.0:
        raison_rejet = "Taux de trihalométhanes supérieur au seuil de sécurité (80.0 ppm)."
